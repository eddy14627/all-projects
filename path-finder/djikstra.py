...
cols, rows = 64, 48    #------------------> this is used for making block

w = width//cols    #---------------------> // works as GIF of width/col
h = height//rows
...
# row = input("enter row of starting point: ") 
# col = input("enter col of starting point: ") 
start = grid[0][0]    #----------------------------------------> this is starting
